    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-10 w-72 h-72 rounded-full bg-cyan-400/20 blur-3xl animate-pulse-slow" />
          <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-primary/30 blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }} />
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 lg:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6 animate-fade-in-up">
              ...
              <span className="block mt-2 bg-gradient-to-r from-cyan-300 to-cyan-100 bg-clip-text text-transparent">
                Resource Portal
              </span>
            </h1>

            <p className="text-xl text-primary-foreground/80 mb-10 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              >
                <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-primary shadow-md group-hover:shadow-lg transition-shadow mb-6">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center bg-gradient-hero rounded-3xl p-12 relative overflow-hidden">
            <div className="absolute inset-0 opacity-20">
              <div className="absolute top-0 right-0 w-48 h-48 rounded-full bg-cyan-400 blur-3xl" />
              <div className="absolute bottom-0 left-0 w-32 h-32 rounded-full bg-primary blur-2xl" />
            </div>
